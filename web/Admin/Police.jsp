<%-- 
    Document   : Police
    Created on : 13 Mar, 2024, 11:25:39 AM
    Author     : hp
--%>
...
<html lang="en" >
    ...
    <body>
        <h1 align="center" id="heading">Police Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%
                    int i = 0;
                    String selQry = "select * from tbl_police";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("police_email")%></td>
                    <td><%=rs.getString("police_address")%></td>
                    <td><%=rs.getString("police_contact")%></td>
                </tr>
                <%
                    }
