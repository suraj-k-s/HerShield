...
<!-- jquery slim -->
        ...
        <!-- swiper slider js -->
        <script src="../Assets/admin/vendors/swiper_slider/js/swiper.min.js"></script>
        <!-- nice select -->
        ...
        <!-- gijgo css -->
        <script src="../Assets/admin/vendors/gijgo/gijgo.min.js"></script>
        <!-- responsive table -->
        ...
        <script src="../Assets/admin/vendors/apex_chart/apexcharts.js"></script>

        <!-- custom js -->
        <script src="../Assets/admin/js/custom.js"></script>

        <script src="../Assets/admin/vendors/apex_chart/bar_active_1.js"></script>
        <script src="../Assets/admin/vendors/apex_chart/apex_chart_list.js"></script>