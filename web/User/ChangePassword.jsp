<%-- 
    ...
    Created on : 22 Feb, 2024, 2:02:00 PM
    Author     : hp
--%>
            ...
            if (request.getParameter("btn_update") != null) 
            {
                ...
                if(rs.next())
                {
                    ...
                    if (dbpassword.equals(currentpassword))
                    {
                        ...
                        {
                            String updateQuery = "update tbl_user SET user_password='"+ request.getParameter("txt_passw") +"' where user_id='" + session.getAttribute("Uid") + "'";  
