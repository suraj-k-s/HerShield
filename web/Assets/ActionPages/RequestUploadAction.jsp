<%-- 
    ...
    Created on : 11 Mar, 2024, 12:05:41 PM
    Author     : hp
--%>
...
//checking if request cotains multipart data
            ...
            if (isMultipart) {
                ...
                //Strinh str1="insert into tbl_user ()";//inserting file
                    String InsQry = "INSERT INTO tbl_request( request_title,request_details,request_file,request_date,user_id,advocate_id)"
                            + "values('" + value[0] + "','" + value[2] + "','" + photo + "',curdate(),'"+session.getAttribute("Uid")+"','"+value[1]+"')";
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../User/SendRequest.jsp'
