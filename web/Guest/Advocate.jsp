<%-- 
    Document   : Advocate
    Created on : 22 Feb, 2024, 2:03:26 PM
    Author     : hp
--%>
...
<html>
    ...
    <body>
        ...
        <form enctype="multipart/form-data" method="post" action="../Assets/ActionPages/AdvocateUploadAction.jsp">
            <table border="1">
                <tr>
                    <td>Name</td>
                ...
                <tr>
                    <td>Proof</td>
                    <td>
                        <input type="file" name="photofile" id="photofile" required=""/>
                    </td>
                </tr>
                <tr>
                    <td>Password</td>
